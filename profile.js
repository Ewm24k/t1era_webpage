...
(function initDisplayNameEdit() {
  function attachPencilHandler() {
    const pencilBtn = document.querySelector(".editable-field .edit-pencil");
    const nameSpan = document.getElementById("displayFullName");
    if (!pencilBtn || !nameSpan) return;

    pencilBtn.addEventListener("click", (e) => {
      e.stopPropagation();
      // Don't open if already editing
      if (document.getElementById("displayNameInput")) return;
      ...
      confirmBtn.className = "display-name-confirm";
      confirmBtn.title = "Save name";
      confirmBtn.innerHTML = '<i class="ph-bold ph-check"></i>';

      // Build cancel button
      const cancelBtn = document.createElement("button");
      cancelBtn.className = "display-name-cancel";
      cancelBtn.title = "Cancel";
      cancelBtn.innerHTML = '<i class="ph-bold ph-x"></i>';

      // Hide span and pencil, insert controls
      nameSpan.style.display = "none";
      pencilBtn.style.display = "none";
      const field = pencilBtn.parentElement;
      field.appendChild(input);
      field.appendChild(confirmBtn);
      ...
      async function saveName() {
        ...
        confirmBtn.innerHTML = '<i class="ph-bold ph-spinner"></i>';
        ...
        try {
          ...
          console.warn("saveDisplayName error:", err);
  ...
  if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", attachPencilHandler);
  } else {
    attachPencilHandler();
  }
})();
