import { initializeApp, getApps } from "https://www.gstatic.com/firebasejs/10.12.2/firebase-app.js";
      ...
      const PROMPT_LIBRARY = [
        {
          id: "p1",
          question: "What single habit completely changed your productivity — and could you ever go back to life without it?",
          hint: "Share a concrete habit, routine, or system that made the biggest difference.",
        },
        {
          id: "p2",
          question: "What is the most underrated tool for remote teams in 2025 that most people still haven't discovered?",
          hint: "Name it, explain what it does, and why it matters.",
        },
        {
          id: "p3",
          question: "Describe your ideal morning routine in 3 steps — be specific. What time, what actions, and what outcome?",
          hint: "Be precise: times, durations, and why each step matters to you.",
        },
        {
          id: "p4",
          question: "If you could only read one book this year to grow professionally, what would it be and why?",
          hint: "Give the title, one key insight, and who you'd recommend it to.",
        },
        {
          id: "p5",
          question: "What is the best career advice you ever received — and did you follow it?",
          hint: "Share the advice, who gave it, and how it shaped your path.",
        },
        {
          id: "p6",
          question: "What skill do you wish you had learned 5 years earlier, and how would it have changed things?",
  ...
  `;
      ...
      function cyclePrompt(direction) {
        _activePromptIndex = (_activePromptIndex + direction + PROMPT_LIBRARY.length) % PROMPT_LIBRARY.length;
        renderActivePromptInBox();
        const ta = document.getElementById("promptTa");
