...
(function (global) {
  ...
  function injectCSS() {
    ...
    s.textContent = [
      ...
      ".sl-proj-tab{display:inline-flex;align-items:center;gap:7px;padding:7px 14px;border-radius:9999px;font-size:12px;font-weight:600;border:1px solid rgba(255,255,255,0.1);background:#1e1e24;color:#9aa0a6;cursor:pointer;transition:all 0.15s;font-family:'Inter',sans-serif;}",
      ...
      ".cp-gpu-vram{font-size:10px;color:#5f6368;font-family:'JetBrains Mono',monospace;flex-shrink:0;}",
      ...
      ".cp-btn-add{display:inline-flex;align-items:center;gap:6px;padding:8px 16px;border-radius:9px;font-size:12px;font-weight:600;border:1px solid rgba(138,180,248,0.3);background:rgba(138,180,248,0.08);color:#8ab4f8;cursor:pointer;transition:all 0.15s;font-family:'Inter',sans-serif;}",
      ".cp-btn-add:hover{background:rgba(138,180,248,0.18);border-color:rgba(138,180,248,0.5);}",
      ".cp-btn-switch{display:inline-flex;align-items:center;gap:6px;padding:8px 14px;border-radius:9px;font-size:12px;font-weight:600;border:1px solid rgba(255,255,255,0.07);background:transparent;color:#9aa0a6;cursor:pointer;transition:all 0.15s;font-family:'Inter',sans-serif;}",
